...
\usepackage{longtable} % for tables spanning multiple pages (used by the GLP Networking API appendix)
\usepackage{colortbl} % for \rowcolor (used by the GLP Networking API appendix)
\usepackage{amsmath} % for aligned and other math environments
