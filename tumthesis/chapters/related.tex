...
There exist a plethora of OppNet routing algorithms, and we will cover the three most famous ones:\begin{itemize}
    ...
    \item \emph{PRoPHET} (Probabilistic Routing Protocol using History of Encounters and Transitivity): The PRoPHET protocol used stochastics
\end{itemize}
Epidemic, Spray-and-Pray, PRoPHET
...
On smartphones, one of the most famous and large-scale deployments was Firechat~\cite{firechat}, which was broadly used in the 2014 Hong Kong protests, and later in Iran and Iraq.
...
However, FireChat was not meant for this use case, as it was lacking basic encryption, privacy, and resilience~\cite{firechat1,firechat2}.
